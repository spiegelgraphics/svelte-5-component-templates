<script>
    ...
    /**
     * @component
     * Awesome Button component that renders a button with optional text, icon, and various states.
     *
...
let { url, customIcon, children, icon = "arrow", disabled = false, secondary, buttonClicked = () => {}    } = $props();
    ...
    <button {disabled} onclick={buttonClicked}
        ...
        <span>
            ...
            {:else if icon === "spiegelplus"}
                <svg class="spiegelplus" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                    <path d="M12.7 17.5906V10.5436H7.11051V7.34899H9.90005V9.32215H12.7V6.50336C12.7 5.60133 11.8632 5 11.02 5H5.79896C4.95582 5 4.30005 5.65772 4.30005 6.50336V12.8926H9.88605V16.745H7.01682V14.1141H4.30005V17.4966C4.30005 18.3423 4.95582 19 5.79896 19H11.104C11.9662 19 12.7 18.4362 12.7 17.5906Z"/>
...
<style lang="scss">
  ...
  button {
    ...
    color: var(--textColor, $basic-white);
    height: 44px;
    background: var(--backgroundColor, $primary-base);

    @media (prefers-color-scheme: dark) {
      background-color: var(--backgroundColorDark, $primary-base-dark);
    }
    ...
    path, circle {
      stroke: var(--textColor, $basic-white);
    ...
    &:hover {
      background: var(--hoverColor, $primary-dark);
    }

    &:active {
      background: var(--activeColor, $primary-darker);
    }

    &:disabled {
      path, circle {
        stroke: var(--disabledTextColor, $basic-gray-dark);
      }

      pointer-events: none;
      color: var(--disabledTextColor, $basic-gray-dark);
      background-color: var(--disabledBackgroundColor, $shade-lighter);
    }
    ...
    .spiegelplus path {
      fill: var(--textColor, $basic-white);
      stroke: transparent;
    }
  }
</style>
