<script>
	...
	let {
		...
		useCardLayout // Spezialfall für CardLayout im Multiwrap (kein TabNavigation-Standard)
	} = $props();
...
<style lang="scss">
	...
	.fade {
		...
		&.card-layout {
			@media (prefers-color-scheme: dark) {
				--duv-ui-tabnavi-fade-start: rgba(42, 41, 41, 0);
				--duv-ui-tabnavi-fade-end: rgba(42, 41, 41, 1);
			}
		}
